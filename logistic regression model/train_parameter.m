...
%      Version: 0.0.1
%   LastChange: 2012-10-17 09:10:13
%      History:
%=============================================================================

function [theta_opt,cost_fun_vals,is_con] = train_parameter(X_train,Y_train,theta,eta,iter_nums,epsilon)
...
for i=1:iter_nums,
    ...
    theta = theta - 1/m*eta*X_train'*(Y_pr-Y_train);
