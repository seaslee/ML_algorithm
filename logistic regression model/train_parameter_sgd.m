%=============================================================================
%     FileName: train_parameter_sgd.m
%         Desc: train parameter for logistic regression using sgd
%       Author: XuXinchao
%        Email: xxinchao@gmail.com
%     HomePage: http://webdancer.is-programmer.com
%      Version: 0.0.1
%   LastChange: 2012-10-17 09:13:16
%      History:
%=============================================================================
function [theta_opt,cost_fun_vals,is_con] = train_parameter_sgd(X_train,Y_train,theta,eta,iter_nums,epsilon)
